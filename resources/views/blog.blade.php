    ...
    <div class="container">
        <div class="row d-flex align-items-center" style="height: 50vh">
            <div class="col-lg-6 col-md-12">
                <h1 class="text-white fs-7 animate__animated animate__fadeInUp">Our Blogs</h1>
            </div>
        </div>
    </div>
</section>
...
<div class="container pt-6">
    <div class="row">
        <div class="col-lg-7">
            <div class="blog mb-5">
                <img src="{{ asset('image/blog4.jpg') }}" class="blogImg ">
            ...
            <div class="blog mb-5">
                <img src="{{ asset('image/blog2.jpg') }}" class="blogImg ">
                <div class="blogShadow">
                    <button class="blogDate btn">
             ...
             <div class="blog mb-5">
                <img src="{{ asset("image/blog3.jpg") }}" class="blogImg ">
                <div class="blogShadow ">
                    <button class="blogDate btn">
            ...
            <div class="blog mb-5">
                <img src="{{ asset('image/blog1.jpg') }}" class="blogImg ">
            ...
            <div class="blog mb-5">
                <img src="{{ asset('image/blog5.jpg') }}" class="blogImg ">
                <div class="blogShadow">
                    <button class="blogDate btn">
                        <h3 class="fw-bolder">12</h3>
                        <p class="fw-bolder">Dec</p>
                    </button>
                    <div class="p-lg-5 py-3 px-3">
                        <h3 class="txt fw-bolder pb-2">Google inks pact for new 35-storey office</h3>
                        <p class="text-white">That dominion stars lights dominion divide years for fourth have don't stars is that he earth it first without heaven in place seed it second morning saying.</p>
                        <div class="d-flex text-warning">
                            <div class="pe-5">
                                <i class="fa-solid fa-user pe-2"></i>
                                <small class="text-warning text-decoration-none">Let Make Choco Cake</small>
                            </div>
                            <div class="">
                                <i class="fa-solid fa-comments pe-2"></i>
                                <small class="text-warning text-decoration-none">03 Comments</small>
        ...
        <div class="col-lg-5">
            ...
            <div class="bg-white py-4 px-5 my-4">
                ...
                <div class="d-flex pt-5 pb-4">
                    <img src="{{ asset('image/feed1.jpg') }}" class="feedImg " >
                ...
                <div class="d-flex pb-4">
                    <img src="{{ asset('image/feed2.jpg') }}" class="feedImg " >
                    <div class="d-flex align-items-center">
                        <div class="ps-4">
                ...
                <div class="d-flex pb-4">
                    <img src="{{ asset('image/feed3.jpg') }}" class="feedImg " >
                    <div class="d-flex align-items-center">
                        <div class="ps-4">
                ...
                <div class="d-flex pb-4">
                    <img src="{{ asset('image/feed4.jpg') }}" class="feedImg " >
                    <div class="d-flex align-items-center">
                        <div class="ps-4">
            ...
            <div class="bg-white py-4 px-5 mt-4">
                ...
                <div class="pt-4">
                    <div class="row">
                        <div class="col-4">
                            <img src="{{ asset('image/feed5.jpg') }}" class="feedImgBig py-2 msn">
                        </div>
                        <div class="col-4">
                            <img src="{{ asset('image/feed6.jpg') }}" class="feedImgBig py-2 msn" >
                        </div>
                        <div class="col-4">
                            <img src="{{ asset('image/feed7.jpg') }}" class="feedImgBig py-2 msn">
                        </div>
                        <div class="col-4">
                            <img src="{{ asset('image/feed1.jpg') }}" class="feedImgBig py-2 msn">
                        </div>
                        <div class="col-4">
                            <img src="{{ asset('image/feed2.jpg') }}" class="feedImgBig py-2 msn">
                        </div>
                        <div class="col-4">
                            <img src="{{ asset('image/feed3.jpg') }}" class="feedImgBig py-2 msn">
                        </div>
                    </div>
                </div>
            </div>
